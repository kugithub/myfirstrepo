...
class CustomerServiceTest {
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        SecurityInterface mocked = PowerMockito.mock(SecurityInterface.class);
        ...
        service.onStart();
        assertTrue(service.onHealthCheck());
    }
    ...
    @Test
    void testReturnEmptySearchOnInvalidInput() throws Exception {
        //Invalid Email
        EmployeeSearch empty_ = service.employeeLookup("invalid@@@com", 0, 10);
        assertNotNull(empty_);
        assertEquals(10, empty_.getLimit());
        assertEquals(0, empty_.getPage());
        assertEquals(0, empty_.getEmployees().size());
    }
