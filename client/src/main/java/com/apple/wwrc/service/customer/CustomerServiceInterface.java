...
/**
 *  This is your service common class. Make sure it's documented here. Added one more comment more more
 */

@POSService(version="v1.0", name="CustomerService")
public interface CustomerServiceInterface {

	// exposed public APIs (Will e availabe at gateway)
	@POSApi(name="searchEmployee", desc="Employee lookup api.")
	@POSMethod()
	EmployeeSearch employeeLookup(@ApiParam(value="query", desc="encrypted badgeId or email address")String query,
